# rw-pressure-vessel-gemini-0001: Gemini Pressure-Vessel Capture Slot
...
```json
{
  ...
  "source": {"kind": "manual_model_run", "description": "Pending Gemini run using pressure_vessel_prompt_v1.", "raw_output_available": false},
  "model_name": "Gemini",
  "model_version": null,
  "run_date": null,
  ...
  "notes": {"assumptions_stated": [], "limitations": ["Pending raw model output."], "reviewer_notes": "", "expected_verifier_behavior": "Pending classification after Gemini output is captured."}
}
```

## Run Instructions

Run `prompts/pressure_vessel_prompt_v1.md` in Gemini and paste the raw response
into `llm_response.response`.
