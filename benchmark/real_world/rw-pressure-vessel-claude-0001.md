# rw-pressure-vessel-claude-0001: Claude Pressure-Vessel Capture Slot
...
```json
{
  ...
  "source": {"kind": "manual_model_run", "description": "Pending Claude run using pressure_vessel_prompt_v1.", "raw_output_available": false},
  "model_name": "Claude",
  "model_version": null,
  "run_date": null,
...
Run `prompts/pressure_vessel_prompt_v1.md` in Claude and paste the raw response
